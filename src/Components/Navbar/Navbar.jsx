      ...
      <div className="navbar max-w-7xl bg-black bg-opacity-40 fixed z-10 h-[90px] text-white">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            >
              ...
              <li>
                <NavLink to="/apartment" className="text-black font-bold">
                  Apartment
                </NavLink>
              </li>
            </ul>
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1">
            ...
            <li>
              <NavLink to="/apartment" className="font-bold">
                Apartment
              </NavLink>
            </li>
          </ul>
          ...
          {user ? (
            <div className="dropdown dropdown-end">
              ...
              <div className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                <h1 className="text-center w-full text-black font-bold">
                  {user?.displayName}
                </h1>
                <Link
                  to={
                    role === 'admin'
                      ? '/dashboard/my-profile-admin'
